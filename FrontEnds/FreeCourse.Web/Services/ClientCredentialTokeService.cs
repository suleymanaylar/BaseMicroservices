...
{
    public class ClientCredentialTokeService : IClientCredentialTokeService
    {
        ...
        public ClientCredentialTokeService(IOptions<ServicesApiSettings> serviceApiSettings, IOptions<ClientSettings> clientSettings, IClientAccessTokenCache clientAccessTokenCache, HttpClient httpClient)
        {
